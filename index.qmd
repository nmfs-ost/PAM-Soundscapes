...
2.  **Identify datasets:** Decide on priority Noise Reference Station (NRS) datasets for metric development.

3.  **Data products to NCEI:** NRS Hybrid Milli-Decade (HMD) products to be included in initial comparison sent to NCEI.

4.  **Identify visualization options:** Organize and expand on options for HMD data visualizations as originally prepared for PAMscapes, share with working group via Google doc folder for discussion of level 1 visualization goals. Ideas and inspiration will be organized for project team brainstorming and feedback meeting.

5.  **Develop workplan:** Set-up work plan with Taiki Sakai to evaluate HMD QA/QC with visualizations in PAMscapes including level 1 visualizations such as percentiles, LTSA, and bringing together MANTA and pyPAM default outputs.

6.  **Present initial results:** Updated PAMscapes tool for HMD QA/QC level 1 visualization will be shared with project team for feedback and further development.
...
9.  **Cloud processing:** Following Cloud Computing project Phase 7 (Software phase II validation), conduct cloud processing for HMD and PAMscapes to apply relevant methods on FMCs priority datasets.

10. **Facilitate national comparisons:** Develop additional products or visualizations for nationwide comparison of FMC priority soundscapes.

11. **Present project outcomes:** Present tested and functional cloud processing routines for level 1-3 products for all priority data sets for PAM SI reporting and additional science needs.
